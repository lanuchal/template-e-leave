...
function PdfRate() {
  const genPdf = () => {
    ...
    doc.text("ลงชื่อ", 27, yPresident+ 50);
    doc.text("( " + presidentName + " )", 60, yPresident + 56, null, null, "center");
    doc.text(presidentPosition, 60, yPresident + 62, null, null, "center");
    doc.text(presidentDate, 60, yPresident + 68, null, null, "center");
